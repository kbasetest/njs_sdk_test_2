...
function njs_sdk_test_2(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "njs_sdk_test_2.run",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "njs_sdk_test_2.status",
