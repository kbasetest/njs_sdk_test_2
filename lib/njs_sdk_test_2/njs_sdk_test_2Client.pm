package njs_sdk_test_2::njs_sdk_test_2Client;
...
njs_sdk_test_2::njs_sdk_test_2Client
...
sub new
{
    ...
    my $self = {
	client => njs_sdk_test_2::njs_sdk_test_2Client::RpcClient->new,
	url => $url,
	headers => [],
    };
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for njs_sdk_test_2::njs_sdk_test_2Client\n";
    }
    if ($sMajor == 0) {
        warn "njs_sdk_test_2::njs_sdk_test_2Client version is $svr_version. API subject to change.\n";
    }
}
...
package njs_sdk_test_2::njs_sdk_test_2Client::RpcClient;
